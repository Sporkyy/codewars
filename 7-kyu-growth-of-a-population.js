...
strictEqual(nbYear(1500, 5, 100, 5000), 15);
strictEqual(nbYear(1500000, 2.5, 10000, 2000000), 10);
strictEqual(nbYear(1500000, 0.25, 1000, 2000000), 94);